...
// Mendelmax 3 
//  If using MM2 Pulleys change the step per unit "100" below to "80"
//  If using 2 start Z leadscrews Z step per unit use "800", If 4 start use "400", if single start use "1600"
//
//                                      X , Y , Z , E0
...
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS 0.02 //changed 9/20/16 - Canaan , check z crash   // 3 max postions below are configed smaller to avoid new users from crashing their axis
...
#define Z_MAX_POS 195 // will need to be adjust for MTW users for full travel range
...
#define Z_MIN_PROBE_REPEATABILITY_TEST  // If not commented out, Z-Probe Repeatability test will be included if Auto Bed Leveling is Enabled.
  ...
  #define Y_PROBE_OFFSET_FROM_EXTRUDER +57     // Z probe to nozzle Y offset: -front +behind
